              ...
              <div className={`${classes.nav__right}`}>
                ...
                >
                  ...
                  <Link
                    ...
                    id="github-account"
                    className={`cursor-pointer text-[#ffffff] hover:text-[#24292E] transform ease-in-out hover:-translate-y+1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiGithubFill />
                  </Link>
                  ...
                  <Link
                    ...
                    id="twitter-account"
                    className={`cursor-pointer text-[#ffffff] hover:text-[#000000] transform ease-in-out hover:-translate-y+1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <NewTwitterLogo/>
                  </Link>
