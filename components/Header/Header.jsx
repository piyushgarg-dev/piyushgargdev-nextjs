        ...
        <div className={`${classes.nav__wrapper}`}>
          ...
          >
            <div className={`${classes.nav__menu}`}>
              ...
              <div className={classes.toggle_slide}>
                <label>
                  <input
                    hidden
                    type="checkbox"
              ...
              <div className={`${classes.nav__right}`}>
                ...
                >
                  <Link
                    ...
                    id="youtube-channel"
                    className={`cursor-pointer  text-[--site-icon-color] hover:text-[--site-theme-color] transform ease-in-out hover:-translate-y+1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiYoutubeFill />
                  </Link>
