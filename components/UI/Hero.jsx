            ...
            <div className="mt-5 flex place-content-center md:block">
              <div className="relative inline-flex group">
                ...
                <Link
                  ...
                  className="relative text-sm sm:text-md md:text-lg flex items-center justify-center px-8 py-4 font-bold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                  role="button"
                >
                  <span className="block">Join Discord Server</span>
                  <span className="block ml-2">
                    <RiDiscordFill  size="1.5em"  /> {/* Discord Icon */}
                  </span>
                </Link>
            ...
            <div className="mt-5 flex flex-col items-center justify-center">
              <div className="relative inline-flex group">
                ...
                <Link
                  target="_blank"
                  href="https://discord.gg/kRSRxBQ6xf"
                  className="relative w-full text-sm sm:text-md md:text-lg flex text-center items-center justify-center px-8 py-4  font-bold text-white transition-all duration-200 bg-gray-900 font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                  role="button"
                >
                  <span className="block">Join Discord Server</span>
                  <span className="block ml-2">
