        ...
        <Row className="flex justify-between flex-col md:flex-row ">
          <Col lg="4" md="6">
            ...
            <div className={`${classes.social__links}`}>
              <Link
                className="hover:text-[red] duration-300 youtube"
              ...
              <Link
                className="hover:text-[white] duration-300 github"
              ...
              <Link
                className="hover:text-[white] duration-300 twitter"
              ...
              <Link
                className="hover:text-[#007FFF] duration-300 linkedin"
